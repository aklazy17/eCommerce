...
using eCommerce.Notification.API.BackgroundServices;
...
{
    string databaseName = builder.Configuration.GetConnectionString("NotificationDbConnection") ?? throw new InvalidOperationException("NotificationDbConnection is not set");
